...
@section('content')
     ...
     <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">       
        ...
        <!-- services -->
        <div class="services-area wrapper-padding-4pt-80 pb-80" style="background-color: #C34546">
            <div class="container-fluid">
                <div class="section-title-furits text-center">
                    <h2 class="text-light" style="margin-top: 90%">Why Choose Us</h2>
                </div>
                <br>
                <div class="services-wrapper mt-40">
                    <div class="single-services mb-40">
                        <div class="services-img">
                            <img src="{{ asset('frontend/assets/img/icon-img/choose.jpeg') }}" alt="">
                        </div>
